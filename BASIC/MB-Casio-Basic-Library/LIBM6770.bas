...
10 MODE8:DIM:GOSUB900:ERASEb$:DIMb$(1):b$(0)="Reject":b$(1)="Accept":t$="Test     H:p=p  H:p"+CHR$(sq)+"p":f=5:c$=CHR$(5):DEFCHR$(252)="123E020000":DEFCHR$(253)="2E2A3A0000":r=0:s=0:t=0:u=0
45 CLS:PRINTt$;
