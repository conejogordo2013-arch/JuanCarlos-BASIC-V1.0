...
5520 DATA"Angle() - y=ax+b,y=cx+d",,5510,5530
5530 DATA"Distance - y=ax+b,(x1,y1)",,5520,5540
5540 DATA"(X,Y) - (x,y),angle()",,5530,5550
...
6650 DATA"Estimation  a</<b         N(,),N(,)",,6640,6660
6660 DATA"Estimation  a<-<b           N(,),N(,)",,6650,6670
6670 DATA"Estimation  a<p<b               B(1,p)",,6660,6680
6680 DATA"Estimation  a<p-p<b           B(1,p),B(1,p)",,6670,6710
6710 DATA"Test N(,) :known                H:=    H:",,6680,6711
6711 DATA"Test N(,) :known                H:=    H:>",,6710,6712
6712 DATA"Test N(,) :known                H:=    H:<",,6711,6720
6720 DATA"Test N(,)                         H:=    H:",,6712,6721
6721 DATA"Test N(,)                         H:=    H:>",,6720,6722
6722 DATA"Test N(,)                         H:=    H:<",,6721,6730
6730 DATA"Test N(,)                         H:=  H:",,6722,6731
6731 DATA"Test N(,)                         H:=  H:>",,6730,6732
6732 DATA"Test N(,)                         H:=  H:<",,6731,6740
6740 DATA"Test N(,),N(,)             H:= H:",,6732,6741
6741 DATA"Test N(,),N(,)             H:= H:>",,6740,6742
6742 DATA"Test N(,),N(,)             H:= H:<",,6741,6750
6750 DATA"Test N(,),N(,)               H:=   H:",,6742,6751
6751 DATA"Test N(,),N(,)               H:=   H:>",,6750,6752
6752 DATA"Test N(,),N(,)               H:=   H:<",,6751,6760
6760 DATA"Test B(1,p)                          H:p=p    H:pp",,6752,6761
6761 DATA"Test B(1,p)                          H:p=p    H:p>p",,6760,6762
6762 DATA"Test B(1,p)                          H:p=p    H:p<p",,6761,6770
6770 DATA"Test B(1,p),B(1,p)                 H:p=p   H:pp",,6762,6771
